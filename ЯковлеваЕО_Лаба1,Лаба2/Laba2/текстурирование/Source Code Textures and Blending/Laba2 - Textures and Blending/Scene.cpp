...
void CScene::Draw()
{
  ...
  glTranslatef(0.0, 0.0, -100.0f); // zoom scene by mouse
  glTranslatef(0.0, 0.0, m_yZoom); // zoom scene by mouse

  //  выбираем изначальный обзор
  glRotatef(90, 1.0f, 0.0f, 0.0f);

  //  корректируем угол мышкой
  glRotatef(m_xPos, 1.0f, 0.0f, 0.0f); // rotate "around" the scene by mouse
